...
public class DocumentWSSoapBindingStub extends org.apache.axis.client.Stub implements com.kingmed.dp.soap.service.client.DocumentWS {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.addFault(new org.apache.axis.description.FaultDesc(
                      new javax.xml.namespace.QName("http://client.service.soap.dp.kingmed.com", "fault"),
                      "com.kingmed.dp.soap.service.fault.DocumentWSFault",
                      new javax.xml.namespace.QName("urn:fault.service.soap.dp.kingmed.com", "DocumentWSFault"), 
                      true
                     ));
        _operations[0] = oper;
        ...
        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("createDocumentByDomainUserV1");
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "caseParams"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://xml.apache.org/xml-soap", "Map"), java.util.HashMap.class, false, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "leaveParams"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://xml.apache.org/xml-soap", "Map"), java.util.HashMap.class, false, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "sectionParams"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://xml.apache.org/xml-soap", "Map"), java.util.HashMap.class, false, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "domainUserId"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, false, false);
        oper.addParameter(param);
    ...
    public DocumentWSSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            qName = new javax.xml.namespace.QName("urn:fault.service.soap.dp.kingmed.com", "DocumentWSFault");
            cachedSerQNames.add(qName);
            cls = com.kingmed.dp.soap.service.fault.DocumentWSFault.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
    ...
    public int updateDocumentByDomainUser(java.lang.String documentId, java.util.HashMap parameters, java.lang.String domainUserId, java.lang.String applicationId) throws java.rmi.RemoteException, com.kingmed.dp.soap.service.fault.DocumentWSFault {
        ...
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://client.service.soap.dp.kingmed.com", "updateDocumentByDomainUser"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {documentId, parameters, domainUserId, applicationId});
    ...
    if (axisFaultException.detail != null) {
        ...
        if (axisFaultException.detail instanceof com.kingmed.dp.soap.service.fault.DocumentWSFault) {
              throw (com.kingmed.dp.soap.service.fault.DocumentWSFault) axisFaultException.detail;
         }
   }
  throw axisFaultException;
    ...
    public int createDocumentByDomainUser(java.lang.String formName, java.util.HashMap parameters, java.lang.String domainUserId, java.lang.String applicationId) throws java.rmi.RemoteException, com.kingmed.dp.soap.service.fault.DocumentWSFault {
        ...
        _call.setSOAPActionURI("");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://client.service.soap.dp.kingmed.com", "createDocumentByDomainUser"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {formName, parameters, domainUserId, applicationId});
  ...
  throw axisFaultException;
    ...
    public int createDocumentByDomainUserV1(java.util.HashMap caseParams, java.util.HashMap leaveParams, java.util.HashMap sectionParams, java.lang.String domainUserId, java.lang.String applicationId) throws java.rmi.RemoteException, com.kingmed.dp.soap.service.fault.DocumentWSFault {
        ...
        _call.setSOAPActionURI("");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://client.service.soap.dp.kingmed.com", "createDocumentByDomainUserV1"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {caseParams, leaveParams, sectionParams, domainUserId, applicationId});
