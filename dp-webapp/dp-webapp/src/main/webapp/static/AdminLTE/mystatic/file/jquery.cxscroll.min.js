 ...
 * ����˵��
 * ���			Ĭ��ֵ		˵��
 * direction	'right'		�������򡣿�����Ϊ��"left", "right", "top", "bottom" 
 * easing		'swing'		������ʽ 
 * step			1			�������� 
 * accel		160			�ֶ������ٶ� (ms)��������ư�ť�������ٶȡ� 
 * speed		800			�Զ������ٶ� (ms) 
 * time			4000		�Զ��������ʱ�� (ms) 
 * auto			true		�Ƿ��Զ����� 
 * prevBtn		true		�Ƿ�ʹ�� prev ��ť 
 * nextBtn		true		�Ƿ�ʹ�� next ��ť 
 * safeLock		true		����ʱ�Ƿ�����ư�ť 
 * ===============================================================================
 * HTML Code
