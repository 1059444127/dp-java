      			...
      			<div class="box-body">
	      			<form id="cstCase_form" action="${ctx }/cons/cstCase/list" method="post">
	      				...
	      				<div style="width:100%;">
							...
							<div class="col-xs-5">
								<div class="form-group">
									<label for="statusSearch" class="col-xs-4 control-label padding">诊断意见：</label>
									<div class="col-xs-8 padding">
									<input type="text" class="form-control input-sm"  id="cstDiaSearch" name="cstDia">
									</div>
								</div>
							</div>
...
<script src="${ctxStatic}/modules/consultation/cstCase_listed.js" ></script>