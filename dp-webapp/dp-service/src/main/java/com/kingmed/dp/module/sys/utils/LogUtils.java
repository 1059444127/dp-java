...
public class LogUtils {
	...
	public static void saveLog(HttpServletRequest request, Object handler, Exception ex, String title){
		...
		if (user != null && user.getId() != null){
			...
			//TODO 性能优化
			//方案1 提交到本地线程池中
			//方案2 提交到给actor，actor写入到kafka中
			new SaveLogThread(log, handler, ex).start();
			
			//EXECUTOR_SERVICE.submit(new SaveLogTask(log, handler, ex));
		}
	}

	
	public static class SaveLogTask implements Runnable {

		private Log log;
		private Object handler;
		private Exception ex;

		public SaveLogTask(Log log, Object handler, Exception ex) {
			this.log = log;
