...
import org.os.common.config.Global;
import org.os.common.exception.ServiceException;
import org.os.common.persistence.Page;
import org.os.common.security.Digests;
...
import org.os.common.utils.Encodes;
...
import com.kingmed.dp.modules.sys.dao.RoleDAO;
import com.kingmed.dp.modules.sys.dao.UserDAO;
import com.kingmed.dp.modules.sys.security.SystemAuthorizingRealm;
...
public class SystemService extends BaseService{
	...
	public Page<User> findUser(Page<User> page, User user) {
		...
		//查询一共多少条数据
		page.setCount(userDAO.findList(user).size());
		// 设置分页参数
		user.setPage(page);
		// 执行分页查询
	...
	public Page<Role> findRole(Page<Role> page,Role role){
		// 生成数据权限过滤条件（dsf为dataScopeFilter的简写，在xml中使用 ${sqlMap.dsf}调用权限SQL）
		role.getSqlMap().put("dsf", dataScopeFilter(role.getCurrentUser(), "o", "u"));
		//查询一共多少条数据
		page.setCount(roleDAO.findPageList(role).size());
		// 设置分页参数
		role.setPage(page);
		// 执行分页查询
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	public static boolean printKeyLoadMessage(){
		...
		sb.append("\r\n======================================================================\r\n");
		sb.append("\r\n    欢迎使用 "+Global.getConfig("productName")+"  - Powered By http://www.kingmed.com.cn\r\n");
		sb.append("\r\n======================================================================\r\n");
