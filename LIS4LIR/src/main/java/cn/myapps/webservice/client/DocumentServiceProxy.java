...
public class DocumentServiceProxy implements cn.myapps.webservice.client.DocumentService {
  ...
  public java.lang.Object[] doQuery(java.lang.String sql, java.lang.String dataSourceName, java.lang.String applicationId, java.lang.String domainUserId) throws java.rmi.RemoteException, cn.myapps.webservice.fault.DocumentServiceFault{
    if (documentService == null)
      _initDocumentServiceProxy();
    return documentService.doQuery(sql, dataSourceName, applicationId, domainUserId);
  }
  
  public int doUpdate(java.lang.String sql, java.lang.String dataSourceName, java.lang.String applicationId, java.lang.String domainUserId) throws java.rmi.RemoteException, cn.myapps.webservice.fault.DocumentServiceFault{
    if (documentService == null)
      _initDocumentServiceProxy();
    return documentService.doUpdate(sql, dataSourceName, applicationId, domainUserId);
  }
