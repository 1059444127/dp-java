...
public class SlideDto implements Serializable{
	...
	public String toString() {
		return "SlideDto [barcode=" + barcode + ", label=" + label + ", overview=" + overview + ", labelWithOverview="
				+ labelWithOverview + ", url=" + url + ", scannerModel=" + scannerModel + ", createDateTime="
				+ createDateTime + ", scannerCode=" + scannerCode + ", physicalPath=" + physicalPath + ", path=" + path
